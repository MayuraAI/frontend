...
export const ChatItem: FC<ChatItemProps> = ({ chat }) => {
  ...
  return (
    <div
      ref={itemRef}
      className={cn(
        "focus-ring group flex w-full cursor-pointer items-center rounded-lg py-2 px-3 transition-smooth text-left",
        isActive 
    ...
    >
      ...
      <div
        ...
        className={cn(
          "ml-2 flex items-center space-x-1 transition-smooth",
